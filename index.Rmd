...
#Description of Data
  ...
  My hypothesis was upheld by the data presented by the NYC Department of Education, College Board and US Census Bureau from the 2014-15 school year.  There was a positive relationship between percentage of white students and median household income on SAT scores. However, it was surprising to see that race/ethnicity had a huge effect on SAT scores relative to household income. While household income did seem to have a positive correlation with SAT scores at 0.19 it is quite minuscule compared to the correlation reace/ethnicity had with SAT scores, which was 0.61.
